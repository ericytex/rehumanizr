      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-slate-900 dark:text-white">ReHumanizer</span>
            </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors p-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800"
          ...
          {/* Product Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-slate-900 dark:text-white">Product</h3>
          ...
          {/* Support Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-slate-900 dark:text-white">Support</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-8 mb-8">
          <div className="max-w-md">
            <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white">Stay Updated</h3>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
